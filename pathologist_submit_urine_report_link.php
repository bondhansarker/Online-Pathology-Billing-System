<?php
   ...
   include 'connection_link.php';
    ...
    $BHM = $_POST['BHM'];
    $CK = $_POST['CK'];
    $CRISTROL = $_POST['CRISTROL'];
    $Epinephrin = $_POST['Epinephrin'];
    $Metanephorin = $_POST['Metanephorin'];
    $Normetanephorin = $_POST['Normetanephorin'];
    $Dopamine = $_POST['Dopamine'];
    $COMMENT = $_POST['COMMENT'];


$sql = "INSERT INTO urine_sample_report(Sample_id,Patient_name,Email,Age,Sex,Albumin,ALP,BHM,CK, CRISTROL,Epinephrin,Metanephorin ,Normetanephorin, Dopamine ,COMMENT)VALUES ('$Sample_id','$Patient_name','$Email','$Age','$Sex', '$Albumin', '$ALP','$BHM','$CK','$CRISTROL','$Epinephrin','$Metanephorin', '$Normetanephorin','$Dopamine','$COMMENT')";
